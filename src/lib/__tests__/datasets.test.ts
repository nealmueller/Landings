...
describe("parseFacilitiesMaster", () => {
  it("parses towered, runway, and surface fields", () => {
    const csv = [
      ...
      "KABC,CA,Test Field,Somewhere,Test,37.5,-122.2,yes,5200,paved,public,,https://example.com/abc,airport,faa,no",
      "1CA,CA,Grass Strip,Elsewhere,Test,36.2,-121.1,no,1800,unpaved,private,5551239999,https://example.com/1CA,airport,faa,no"
    ].join("\n");
